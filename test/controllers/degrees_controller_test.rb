...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post degrees_url, params: { degree: { actor_type_id: @degree.actor_type_id, name: @degree.name } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { actor_type_id: @degree.actor_type_id, name: @degree.name } }
