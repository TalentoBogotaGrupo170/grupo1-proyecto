...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { actor_id: @complaint.actor_id, description: @complaint.description } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { actor_id: @complaint.actor_id, description: @complaint.description } }
