...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { actor_id: @institution.actor_id, addres: @institution.addres, mail: @institution.mail, name: @institution.name } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { actor_id: @institution.actor_id, addres: @institution.addres, mail: @institution.mail, name: @institution.name } }
